...
#X_cheb_gamma, V_gamma = Cheb_point(1, N_cheb, 1, 0)
#V_inv_gamma = np.linalg.inv(V_gamma)

#X_cheb_omega, V_omega = Cheb_point(1, N_cheb, 1, 0)
#V_inv_omega = np.linalg.inv(V_omega)
...
#theta2_gamma = np.pi
#theta1_omega = np.pi
#theta2_omega = 2 * np.pi


#A_gamma, B_gamma, C_gamma, D_gamma = Mobius_arc(a, r, theta1_gamma, theta2_gamma)
#A_omega, B_omega, C_omega, D_omega = Mobius_arc(a, r, theta1_omega, theta2_omega)
#Mob_gamma = (A_gamma, B_gamma, C_gamma, D_gamma)
#Mob_omega = (A_omega, B_omega, C_omega, D_omega)

#C_cercle = C_gamma_omega_borne(X_cheb_gamma, X_cheb_omega, V_inv_gamma, Mob_gamma, Mob_omega)

#print("C_omega_gamma cercle :", C_cercle)
#a_gamma = 1j
#b_gamma = 2j
#a_omega = 2j
#b_omega = 1 + 2j

#A_gamma, B_gamma, C_gamma, D_gamma = Mobius_interval_ab(a_gamma, b_gamma)
#A_omega, B_omega, C_omega, D_omega = Mobius_interval_ab(a_omega, b_omega)
#Mob_gamma = (A_gamma, B_gamma, C_gamma, D_gamma)
#Mob_omega = (A_omega, B_omega, C_omega, D_omega)
#C_interval = C_gamma_omega_borne(X_cheb_gamma, X_cheb_omega, V_inv_gamma, Mob_gamma, Mob_omega)
#print("C_omega_gamma interval :", C_interval)
